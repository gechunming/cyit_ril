...
void ril_event_loop()
{
    ...
    for (;;) {
        // update rfds in select() //
        memcpy(&rfds, &readFds, sizeof(fd_set));

        // get time out if have it in timer queue //
        ...
        // Check for timeouts, add to pending queue if have
        processTimeouts();
        // Check for read-ready request in watch table, add to pending queue if have
