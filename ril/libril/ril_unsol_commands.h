...
*/
    ...
    {RIL_UNSOL_STK_SESSION_END, responseInts, WAKE_PARTIAL},// modify by CYIT 20111226 for STK main_menu/secondary_menu display
    ...
    {RIL_UNSOL_PB_INIT_OVER, responseVoid, WAKE_PARTIAL},
    {RIL_UNSOL_NETWORK_LIST, responseStrings, WAKE_PARTIAL}
